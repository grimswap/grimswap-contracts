...
/// @notice Add liquidity to the V2 pool
contract AddLiquidityV2 is Script {
    ...
    function run() external {
        ...
        console.log("=== Adding Liquidity to V2 Pool ===");
